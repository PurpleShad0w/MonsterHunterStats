...
def decrypt(saveslot):
    ...
    subprocess.call("C:/Program Files/010 Editor/010Editor.exe saves/SAVEDATA1000.bin -template:templates/SAVEDATA1000.bt -script:scripts/world_editor.1sc -noui")
