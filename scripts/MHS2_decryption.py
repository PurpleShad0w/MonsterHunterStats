...
def decode():
    ...
    subprocess.call("C:/Program Files/010 Editor/010Editor.exe saves/mhr_slot.bin -template:templates/MHStories2_SaveTemplate.bt -script:scripts/MHS2_editor.1sc -noui")
