...
def merge():
    ...
    df_items = pd.read_csv('outputs/MHWI_output_items.csv')
    df_equipment = pd.read_csv('outputs/MHWI_output_equipment.csv')
    df_tool = pd.read_csv('outputs/MHWI_output_tool.csv')
    df_layered = pd.read_csv('outputs/MHWI_output_layered.csv')
    ...
    df_general.to_csv(r'outputs/MHWI_output.csv',encoding='utf-8')