...
def gather():
    ...
    # Adding dictionaries
    df_dict_items = pd.read_csv('dictionaries/MH3U_dictionary_items.csv')
    df_dict_items.set_index('ID', inplace=True)
    df_dict_equipment = pd.read_csv('dictionaries/MH3U_dictionary_equipment.csv')
    ...
    df3.to_csv(r'outputs/MH3U_output_equipment.csv',encoding='utf-8')