...
def merge():
    ...
    df_items = pd.read_csv('outputs/MH3U_output_items.csv')
    df_equipment = pd.read_csv('outputs/MH3U_output_equipment.csv')
    ...
    df_general.to_csv(r'outputs/MH3U_output.csv',encoding='utf-8')