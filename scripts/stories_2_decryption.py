...
def decode():
    ...
    subprocess.call("C:/Program Files/010 Editor/010Editor.exe mhr_slot_1.bin -template:templates/MHStories2_SaveTemplate.bt -script:scripts/stories_2_editor.1sc -noui")
