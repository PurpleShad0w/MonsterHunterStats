...
df_world = pd.read_csv('outputs/MHWI.csv')
df_stories_2 = pd.read_csv('outputs/MHS2.csv')
df_3u = pd.read_csv('outputs/MH3U.csv')
...
df_general.to_csv(r'outputs/overall.csv',encoding='utf-8')